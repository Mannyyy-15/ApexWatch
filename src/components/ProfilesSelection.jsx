...
export function ProfilesSelection() {
    ...
    return (<div className="profiles-container fixed inset-0 bg-bg-base z-[100] flex flex-col items-center justify-center p-6 overflow-hidden">
      ...
      <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 1, ease: [0.16, 1, 0.3, 1] }} className="text-center relative z-10">
        <h1 className="display-text text-4xl md:text-6xl font-black text-white mb-12 tracking-tighter uppercase filter drop-shadow-[0_0_20px_rgba(229,9,20,0.35)] italic">
            Who's Watching?
        </h1>
        ...
        <div className="flex flex-wrap justify-center gap-8 md:gap-12">
          {profiles.map((profile, idx) => (<motion.div 
            ...
            >
              <div className="w-24 h-24 md:w-36 md:h-36 rounded-[24px] overflow-hidden border border-white/10 group-hover:border-accent group-focus:border-accent transition-all duration-500 shadow-2xl relative group-hover:shadow-[0_0_35px_rgba(229,9,20,0.3)] bg-white/5">
