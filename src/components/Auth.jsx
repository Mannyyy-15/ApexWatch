        ...
        <div className="auth-container fixed inset-0 z-[100] bg-bg-base flex items-center justify-center">
            ...
            >
                ...
                <div className="flex flex-col items-center mb-8">
                    <div className="w-12 h-12 rounded-xl overflow-hidden mb-3.5 shadow-[0_0_30px_rgba(229,9,20,0.3)]">
                ...
                <div className="bg-[#0a0a0a]/90 backdrop-blur-3xl rounded-[24px] p-6 md:p-8 border border-glass-border shadow-[0_25px_50px_rgba(0,0,0,0.7)] hover:border-white/10 transition-colors duration-500">
                    <div className="mb-6">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-3.5">
                        ...
                        <button 
                            type="submit" 
                            disabled={loading}
                            className="w-full bg-accent text-white py-3.5 rounded-xl font-black text-xs uppercase tracking-widest hover:bg-accent-hover hover:scale-[1.01] hover:shadow-[0_0_25px_rgba(229,9,20,0.35)] transition-all duration-300 flex items-center justify-center gap-2 disabled:opacity-50 mt-2 cursor-pointer tv-focusable"
                        >
