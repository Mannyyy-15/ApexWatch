                    ...
                    {!user ? (
                        <div className="py-20 flex flex-col items-center justify-center text-center">
                            ...
                            <button 
                                ...
                                className="bg-white text-black px-12 py-5 rounded-2xl font-black text-xl hover:scale-105 transition-all shadow-[0_0_50px_rgba(255,255,255,0.2)] tv-focusable"
                            >
                                Sign In Now
                            </button>
                        </div>
                                ...
                                <div className="space-y-10">
                                        ...
                                        <div className="bg-white/3 border border-white/5 p-6 rounded-[24px] backdrop-blur-md">
                                            ...
                                            <div className="w-full h-4 bg-white/5 rounded-full overflow-hidden flex mb-6">
                                                <div 
                                                    ...
                                                    className="h-full bg-accent transition-all duration-500 shadow-[0_0_15px_rgba(229,9,20,0.6)]"
                                    ...
                                    <div>
                                        <div className="flex items-center gap-3.5 md:gap-4 mb-6">
                                            <div className="w-1.5 h-6 bg-accent rounded-full shadow-[0_0_15px_rgba(229,9,20,0.6)]"></div>
