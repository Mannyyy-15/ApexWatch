...
export function CategoryView({ type, title }) {
 ...
 <span className="px-2.5 py-0.5 bg-accent/15 border border-accent/30 rounded-full text-[9px] font-black tracking-[0.2em] uppercase text-white ">Featured {title}</span>
